...
var str = currentURL;
var res = str.replace("https://download-game2apk.blogspot.com/p/blog-page.html?url=", "");
...
j++;}
if(a_to_vh==false)
{var encryptedUrl=Base64.encode(a_to_vi);a_to_ve[i].href="https://download-game2apk.blogspot.com/p/blog-page.html?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
